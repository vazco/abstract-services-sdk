...
Packer.prototype.pack = function(value){
  ...
  if (type == 'string'){
    ...
    if (value === null){
      ...
      if (Array.isArray(value) || constructor == Array){
        this.pack_array(value);
      } else if (constructor == Blob || constructor == File) {
        this.pack_bin(value);
      } else if (constructor == ArrayBuffer || value && value instanceof ArrayBuffer) {
...
global.BufferBuilder = BufferBuilderExports.BufferBuilder;
global.binaryFeatures = BufferBuilderExports.binaryFeatures;
global.BlobBuilder = BufferBuilderExports.BlobBuilder;
global.BinaryPack = require('./binarypack');
